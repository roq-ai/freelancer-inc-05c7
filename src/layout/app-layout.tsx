...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contracts', path: '/contracts', entity: 'contract', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    ...
    { name: 'Timesheets', path: '/timesheets', entity: 'timesheet', service: AccessServiceEnum.PROJECT, icon: FiClock },
