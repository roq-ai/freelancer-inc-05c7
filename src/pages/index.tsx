...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Freelancer Inc.`}</title>

        <meta
          name="description"
          content="Welcome to Freelancer Inc., your one-stop platform for building the perfect freelancer SaaS solution. Empowering your freelance journey with cutting-edge technology."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575196644-808978af9b1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2VyfGVufDB8fHx8MTY5OTU1NDg2N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@windows?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Windows`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Freelancer Inc., your one-stop platform for building the perfect freelancer SaaS solution. Empowering your freelance journey with cutting-edge technology.`}
            </Text>
            <Box
