...
import { useRoqPlatformUserProfiles, useTaskCount, useContractCount, useProjectCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const contractStat = useContractCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Contracts',
      result: contractStat?.data,
      isLoading: contractStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Projects',
