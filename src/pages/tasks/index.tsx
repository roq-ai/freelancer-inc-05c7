...
export function TaskListPage(props: TaskListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['project', 'timesheet.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'description', header: 'Description', accessorKey: 'description' },
    {
      ...
      cell: ({ row: { original: record } }: any) => (record?.deadline ? format(record?.deadline, 'dd-MM-yyyy') : ''),
    },
    ...
    hasAccess('timesheet', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.timesheet,
        }
      : null,
