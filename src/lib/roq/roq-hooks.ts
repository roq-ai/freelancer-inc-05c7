...
export function useContractFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useContractFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.contract.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContractCount<T extends Prisma.contractCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.contractCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useContractCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.contract.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContractFindManyWithCount<
  T extends Prisma.contractFindManyArgs,
  R extends { data: GetFindResult<Prisma.$contractPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.contractFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useContractFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.contract.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useContractFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useContractFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.contract.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTimesheetFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTimesheetFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.timesheet.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTimesheetCount<T extends Prisma.timesheetCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.timesheetCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTimesheetCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.timesheet.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTimesheetFindManyWithCount<
  T extends Prisma.timesheetFindManyArgs,
  R extends { data: GetFindResult<Prisma.$timesheetPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.timesheetFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTimesheetFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.timesheet.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTimesheetFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTimesheetFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.timesheet.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
